...
const BiodiversityPage = () => {
  ...
  const closeModal = () => {
   ...
   const openSpeciesPage = (species) => {
    navigate(`/species/${encodeURIComponent(species.name || species.title)}`, { state: { species } });
  };
            ...
            {[
              {
                ...
                details: "Hawksbill turtles live mostly in tropical reefs and are vital for coral health.",
              ...
              },
              {
                ...
                details: "Vaquitas are tiny porpoises found in the northern part of the Gulf of California.",
              ...
              },
              {
                ...
                details: "Bluefin tuna migrate across oceans and are heavily fished for sushi markets.",
